  ...
  useEffect(()=>{
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        let qiblaFromTrueNorth = Qibla.degreesFromTrueNorth(position.coords.latitude, position.coords.longitude);
        arrow.style.transform = `rotate(${qiblaFromTrueNorth}deg)`;
        async function getPrayers(today:string,latitude:number,longitude:number){
          const prayers = qiblaService.getPrayerTimes(today,latitude,longitude)
          setPrayerTimes(await prayers)
          
        }
        getPrayers(today,latitude,longitude)
      })
    },[])
